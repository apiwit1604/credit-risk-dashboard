...
├── pages/
│   ├── 2_📉_Merton_KMV_CVaR.py          # Page 2 — structural Monte Carlo CVaR
│   ├── 3_📊_CreditMetrics_CVaR.py       # Page 3 — rating-migration Monte Carlo CVaR
│   ├── 4_🏦_Basel_Single_Factor_CVaR.py # Page 4 — closed-form regulatory CVaR
│   ├── 5_🧮_Model_Comparison.py         # Page 5 — all three CVaR models side by side
│   ├── 6_🎯_Probability_of_Default.py   # Page 6 — four PD methods
│   └── 7_⚙️_Settings.py                 # Page 7 — rating scale / transition matrix / curves
