...
@st.cache_data(show_spinner=False)
def cached_basel(portfolio, transition_matrix_n, maturity_override: Optional[float], confidence_level: Optional[float]) -> dict:
    return run_single_factor_basel(portfolio, transition_matrix_n, maturity_override, confidence_level)
